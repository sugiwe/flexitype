...
ActiveRecord::Schema[8.1].define(version: 2026_01_12_023136) do
  ...
  create_table "keymap_sets", force: :cascade do |t|
    ...
    t.string "keyboard_type", default: "cornix_4x6", null: false
    t.string "name", limit: 50, null: false
  ...
  create_table "lessons", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["category_id", "display_order"], name: "index_lessons_on_category_id_and_display_order"
  ...
  create_table "users", force: :cascade do |t|
    t.integer "active_keymap_set_id"
    t.datetime "created_at", null: false
